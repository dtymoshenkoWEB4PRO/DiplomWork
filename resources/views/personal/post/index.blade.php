            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-1 mb-3">
                        <a href="{{route('personal.post.create')}}" type="button" class="btn btn-block btn-primary">Додати</a>
                    </div>
                        ...
                        <div class="card-body table-responsive p-0">
                            <table class="table table-hover text-nowrap">
                                ...
                                <tr>
                                    ...
                                    <td class="text-center"><form action="{{route('personal.post.delete', $post->id )}}" method="POST">
                                        @csrf
                                        @method('delete')
